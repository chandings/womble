    ...
    <div className="App">
      ...
      {(showHelp)?(<div className="app-help-container">
        <div className='app-help'>
          ...
          <p>Womble is a word jumble game. Aim is to make as many 3 or more letter words as possible using the letters provided. 
          To be able to move to the next level you need to make at least one word using all the letters.</p>
